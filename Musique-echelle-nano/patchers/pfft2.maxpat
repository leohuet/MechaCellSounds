...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 276.999987125396729, 321.977272689342499, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 194.526363923549752, 321.977272689342499, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 276.999987125396729, 351.659999999999968, 58.0, 22.0 ],
					"text" : "poltocar~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 194.526363923549752, 351.659999999999968, 58.0, 22.0 ],
					"text" : "poltocar~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 276.999987125396729, 385.75, 52.0, 22.0 ],
					"text" : "fftout~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 194.519999999999982, 385.75, 52.0, 22.0 ],
					"text" : "fftout~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 196.772727012634277, 263.590902924537659, 58.0, 22.0 ],
					"text" : "cartopol~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 111.772727251052856, 263.590902924537659, 58.0, 22.0 ],
					"text" : "cartopol~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 196.772727012634277, 230.63635778427124, 45.0, 22.0 ],
					"text" : "fftin~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "signal" ],
					"patching_rect" : [ 116.772714376449585, 230.63635778427124, 45.0, 22.0 ],
					"text" : "fftin~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 356.999999761581421, 263.590902924537659, 58.0, 22.0 ],
					"text" : "cartopol~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 272.0, 263.590902924537659, 58.0, 22.0 ],
					"text" : "cartopol~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "signal" ],
					"patching_rect" : [ 356.999999761581421, 230.63635778427124, 45.0, 22.0 ],
					"text" : "fftin~ 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "signal" ],
					"patching_rect" : [ 276.999987125396729, 230.63635778427124, 45.0, 22.0 ],
					"text" : "fftin~ 3"
				}
